# Major Use Case: The Booking Lifecycle

This document details the end-to-end flow of a customer booking, from search to ticket generation. It involves coordination between  `FlightService`, `BookingService`, `PricingService`, `SeatService`, `PaymentsService`, `TicketService` and `BoardingPassService`.
